...
Кроссплатформенная библиотека на языке C для взаимодействия с устройствами ZET 017, ZET 038, ZET 028 и ZET 058 по протоколу TCP/IP.
...
Системы сбора данных серий ZET 017, ZET 038, ZET 028 и ZET 058:
...
├── example_2/
│ └── example2_zet017tcp.c # Пример использования с ZET 058
